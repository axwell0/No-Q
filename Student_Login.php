...
<section class="u-clearfix u-image u-section-1" id="sec-423b" data-image-width="961" data-image-height="362">
    <div class="u-clearfix u-sheet u-sheet-1">
        <h4 class="u-align-center u-custom-font u-font-montserrat u-text u-text-default u-text-white u-text-1">Student Login</h4>
        <div class="u-form u-login-control u-form-1">
            <form method = "POST" class="u-clearfix u-form-custom-backend u-form-spacing-13 u-form-vertical u-inner-form" name="form" style="padding: 14px;">
                <div class="u-form-group u-form-name">
                    <label for="username-a30d" class="u-label u-text-grey-25 u-label-1">Email</label>
                    <input type="text" placeholder="Enter your Email" id="username-a30d" name="email" class="u-border-2 u-border-grey-10 u-grey-10 u-input u-input-rectangle u-input-1" required="">
                </div>
            ...
            if (isset($_POST["submit"]))
            {
                ...
                if ($res)
                {
                    ...
                    else
                    {
                        ...
                        $_SESSION["studentid"] = $account["student_id"];
                        echo '<script type="text/javascript">window.location.href = "Student_dashboard.php?name='.$_SESSION["name"].'&studentid='.$_SESSION['studentid'].'";</script>';
